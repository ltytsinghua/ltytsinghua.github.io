---
title: "General tensor network theory for frustrated classical spin models in two dimensions"
...
function is written as a product of a one-dimensional transfer operator whose
eigenequation is solved by the standard matrix-product-state algorithm. We demonstrate
the approach on fully frustrated XY spin models on the kagome, square, and triangular
lattices.
